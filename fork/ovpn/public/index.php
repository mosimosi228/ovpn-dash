...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <ul class="nav navbar-right top-nav">
            <li class="dropdown">
                <a href="?section=add_user">Create user</a>
            </li>
            <li class="dropdown">
                <a href="?section=list_users"><i class="fa fa-users"></i> List Users</a>
            </li>
            <li class="dropdown">
                <a href="https://github.com/nathan-fiscaletti/openvpn-panel">Version 1.1</a>
            </li>
	        </ul>
